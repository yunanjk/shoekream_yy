...
@RestController
@RequestMapping("/api/admin/products") // http://3.34.214.103:8899/api/admin/products
public class AdminProductsApiController extends CrudController<ProductApiRequest, ProductApiResponse, Product> {
    ...
    // 생성
    @PostMapping("") // http://3.34.214.103:8899/api/admin/products
    ...
    // 리스트 출력
    @GetMapping("") // http://3.34.214.103:8899/api/admin/products
...
//    }
    ...
    // 상세 보기
    @GetMapping("/{idx}") // http://3.34.214.103:8899/api/admin/products/{idx}
    public Header<ProductApiResponse> read(@PathVariable(name="idx") Long idx) {
        return adminProductApiLogicService.read(idx);
    }

    // 수정
    @PutMapping("/{idx}") // http://3.34.214.103:8899/api/admin/products/{idx}
    ...
    // 삭제
    @DeleteMapping("/{idx}") // http://3.34.214.103:8899/api/admin/products/{idx}
    public Header<ProductApiResponse> delete(@PathVariable(name="idx") Long idx) {
        return adminProductApiLogicService.delete(idx);
    }

    // 첨부 파일 업로드(생성)
    @PostMapping("/uploadFile") // 파일 1개 업로드 //http://3.34.214.103:8899/api/admin/products/uploadFile
