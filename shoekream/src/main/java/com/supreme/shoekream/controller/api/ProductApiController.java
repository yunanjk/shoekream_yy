...
@RequestMapping("/api/product") // http://3.34.214.103:8889/api/product
public class ProductApiController {
    ...
    // 관심상품 생성
    @PostMapping("") // http://3.34.214.103:8889/api/product
    ...
    // 관심상품 삭제
    @DeleteMapping("/{idx}") // http://3.34.214.103:8889/api/product/{idx}
